...
<div class="super_container">
	...
	<header class="header trans_400">
		<div class="header_content d-flex flex-row align-items-center jusity-content-start trans_400">
			...
			<div class="header_extra d-flex flex-row align-items-center justify-content-end ml-auto">
				...
				<!-- Work Hourse -->
				<div class="work_hours">Mon - Sat: 10:30am - 1:00pm & 6:00pm - 8:30pm</div>
	...
	<div class="menu trans_400">
		...
		<div class="menu_extra">
			...
			<div class="menu_link"><a href="tel:+91 9833 037 208">+91 9833 037 208</a></div>
				...
				<div class="col-lg-5 offset-lg-1 contact_col">
					<div class="contact_content">
						...
						<div class="direct_line d-flex flex-row align-items-center justify-content-start">
							...
							<div class="direct_line_num text-center"><a href="tel:+91 9833 037 208" style="color: white;">+91 9833 037 208</a></div>
						</div>
						<div class="contact_info">
							<ul>
								<li class="d-flex flex-row align-items-start justify-content-start">
									<div>Address</div>
									<div>Dave Ayurveda & Wellness Clinic, Shivaji Road, <br> Panvel</div>
								</li>
								<li class="d-flex flex-row align-items-start justify-content-start">
									<div>Phone</div>
									<div>+91 9833 037 208</div>
								</li>
								<li class="d-flex flex-row align-items-start justify-content-start">
									<div>E-mail</div>
									<div>amitdoc@hotmail.com</div>
								</li>
							</ul>
						</div>
				...
				<div class="col">
					...
					<div class="contact_map">
						...
						<!-- Google Map -->	
								...
								<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3772.7176410919114!2d73.10809961490449!3d18.988073459664587!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3be7e814c4379e27%3A0xdedb3a056a5e07b9!2sDr.%20Amit%20B%20Dave%20(Dave%20Ayurveda)!5e0!3m2!1sen!2sin!4v1576489495987!5m2!1sen!2sin" width="1100" height="450" frameborder="0" style="border:0;" allowfullscreen=""></iframe>
							</div>
					</div>
